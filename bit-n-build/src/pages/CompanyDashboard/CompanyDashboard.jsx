...
const CompanyDashboard = () => {
  ...
  const handleAddProduct = async (e) => {
    e.preventDefault();
    try {
      await addProduct(companyNFTAdd, productNameInModal, productPriceInModal);
        ...
        <div className={styles.dashboardBox}>
          ...
          <div className={styles.detailsBox}>
            ...
            <div className={styles.detailsBoxContent}>
              ...
              <span className={styles.name}>{compData.comAdd}</span>
              ...
              <span className={styles.name}>{compData.email}</span>
            </div>
          </div>
